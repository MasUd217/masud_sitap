        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="dash_admin_dt.php">
                    <i class="fas fa-dollar-sign fa-fw text-gray-300"></i>
            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <div class="card ">
                      ...
                      <div class="card-body">
                        <form method="post" action="dash_admin_cp.php">
                           
                            <!-- input password lama -->
                            <div class="mb-3 text-dark">
                              <label for="pass_old" class="form-label">Password Lama</label>
                              <input type="password" class="form-control" id="pass_old" name="pass_old" value="">
                            </div>
                            <!-- input password baru -->
                            <div class="mb-3 text-dark">
