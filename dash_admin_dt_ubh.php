<?php
    ...
    $dt= query2 ("SELECT * FROM transaksi WHERE id = $id")[0];
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <div class="card">
                        <h5 class="card-header bg-primary text-white">Tambah Transaksi Baru</h5>
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="id_transaksi" name="id_transaksi" value="<?= $dt ["id_transaksi"]; ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="tgl_langganan" class="col-sm-2 col-form-label">Berlangganan</label>
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="tgl_langganan" name="tgl_langganan" required value="<?= $dt ["tgl_langganan"]; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="tgl_byr" class="col-sm-2 col-form-label">Jatuh Tempo</label>
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="tgl_byr" name="tgl_byr" required value="<?= $dt ["tgl_byr"]; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="mode_byr" class="col-sm-2 col-form-label">Metode Pembayaran</label>
                                <div class="col-sm-10">
                                    <select id="mode_byr" name="mode_byr" class="form-control">
                                        <option value="<?= $dt ["mode_byr"]; ?>"><?= $dt ["mode_byr"]; ?></option>
                            ...
                            <div class="form-group row">
                                <label for="jml_biaya" class="col-sm-2 col-form-label">Total Biaya</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="jml_biaya" name="jml_biaya" required value="<?= $dt ["jml_biaya"]; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="pembayaran" class="col-sm-2 col-form-label">Ket Pembayaran</label>
                                <div class="col-sm-10">
                                    <select id="pembayaran" name="pembayaran" class="form-control">
                                        <option value="<?= $dt ["pembayaran"]; ?>"><?= $dt ["pembayaran"]; ?></option>
