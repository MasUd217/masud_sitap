<?php
    ...
    $nota = query5("SELECT invoice.id, pelanggan.id_pelanggan, pelanggan.nama, pelanggan.alamat, pelanggan.no_tlp, transaksi.tgl_byr, transaksi.mode_byr, transaksi.jml_biaya, transaksi.pembayaran, jasa.produk, jasa.harga, transaksi.status FROM invoice INNER JOIN pelanggan ON invoice.id_pelanggan = pelanggan.id_pelanggan INNER JOIN transaksi ON invoice.id_transaksi = transaksi.id_transaksi INNER JOIN jasa ON invoice.id_jasa = jasa.id_jasa");
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 ">
                            <h3 class="m-0 font-weight-bold text-primary text-center">INVOICE PELANGGAN</h3>
                        </div>
                        <div class="card-body">
