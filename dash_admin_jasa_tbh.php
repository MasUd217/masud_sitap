        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <div class="card">
                        <h5 class="card-header bg-primary text-white">Tambah Produk Baru</h5>
                    <div class="card-body">
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-group row">
                                <label for="gbr_produk" class="col-sm-2 col-form-label">Gambar Produk</label>
                                <div class="col-sm-10">
                                    <input type="file" class="form-control" id="gbr_produk" name="gbr_produk">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="id_jasa" class="col-sm-2 col-form-label">ID Produk</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="id_jasa" name="id_jasa" required>
                                </div>
                            </div>
                            <div class="form-group row">
