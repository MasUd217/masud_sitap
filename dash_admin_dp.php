<?php
    ...
    $pelanggan = query2("SELECT * FROM pelanggan");
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 ">
                            <h3 class="m-0 font-weight-bold text-primary text-center">Data pelanggan</h3>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="dash_admin_dp_tbh.php?id=<?= $row["id"];  ?>" class="btn btn-success btn-circle btn-sm">
                                                    <i class="fas fa-plus"></i>
                                                </a>
                                                <a href="dash_admin_dp_ubh.php?id=<?= $row["id"];  ?>" class="btn btn-warning btn-circle btn-sm">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <a href="dash_admin_dp_hps.php?id=<?= $row["id"];  ?>" class="btn btn-danger btn-circle btn-sm">
