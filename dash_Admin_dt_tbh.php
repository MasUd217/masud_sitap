                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="tgl_langganan" name="tgl_langganan" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="tgl_byr" class="col-sm-2 col-form-label">Jatuh Tempo</label>
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="tgl_byr" name="tgl_byr" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select id="mode_byr" name="mode_byr" class="form-control">
                                        <option name="mode_byr" value="tunai">Tunai</option>
                                        <option name="mode_byr" value="transfer">Transfer</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="jml_biaya" name="jml_biaya" required>
                                </div>
                            </div>
                            <div class="form-group row">
