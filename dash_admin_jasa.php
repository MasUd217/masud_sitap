                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 ">
                            <h3 class="m-0 font-weight-bold text-primary text-center">Pelayanan Produk dan Jasa</h3>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?= $i; ?></td>
                                            <td h><img src="asset/img/<?= $row["gbr_produk"];  ?>" style="width: 5%;"></td>
                                            <td><?= $row["id_jasa"];  ?></td>
                                            <td><?= $row["produk"];  ?></td>
                                            <td><?= $row["harga"];  ?></td>
                                            <td>
                                                
                                                <a href="dash_admin_jasa_tbh.php?id=<?= $row["id"];  ?>" class="btn btn-success btn-circle btn-sm">
                                                    <i class="fas fa-plus"></i>
                                                </a>
                                                <a href="dash_admin_jasa_ubh.php?id=<?= $row["id"];  ?>" class="btn btn-warning btn-circle btn-sm">
                                                    <i class="fas fa-cogs"></i>
                                                </a>
                                                <a href="dash_admin_jasa_hps.php?id=<?= $row["id"];  ?>" class="btn btn-danger btn-circle btn-sm">
