<?php
    ...
    //$tampil = mysqli_query($conn, "SELECT * FROM tb_users WHERE username = '$namauser' and password = '$pass_lama' ");

    //$data = mysqli_fetch_array($tampil);

    //uji apakah datanya ditemukan atau tidak.
    //if($data){
        //jika password baru dan konfirmasi password sama maka password sesuai.
        //$password_baru = $_POST['pass_new'];
        //$konfirmasi_password = $_POST['conf_pass'];

        //if($password_baru == $konfirmasi_password){
            //proses mengganti password
            //dengan enkripsi password baru.
            //$pass_ok = md5($konfirmasi_password);
            //$ganti = mysqli_query($conn, "UPDATE tb_users SET password = '$pass_ok' WHERE id = '$data[id]' ");
            //if($ganti) {
                //echo "<script>alert('Password anda berhasil diubah, silahkan logout untuk menguji password anda!');
        //document.location='dash_admin_cp_output.php'</script>";
            //}

        //} else {
            //echo "<script>alert('maaf, password baru dan konfirmasi password yang anda masukan tidak sesuai!');
        //document.location='dash_admin_cp.php'</script>";
       // }
                      ...
                      <div class="card-body">
                        <form method="post" action="">
                            ...
                            <div class="mb-3 text-dark">
                              ...
                              <input type="password" class="form-control" id="conf_pass" name="conf_pass" value="">
                            </div>
